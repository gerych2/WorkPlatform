...
import { User, Mail, Phone, MapPin, Edit, Save, X, Camera, Star, Clock, DollarSign, CheckCircle } from 'lucide-react'
...
export default function ExecutorProfile() {
  const [profile, setProfile] = useState<ExecutorProfile>({
          firstName: 'Исполнитель',
      lastName: '',
      email: 'executor@example.com',
    phone: '+375 (29) 987-65-43',
    address: 'Минск, ул. Ленина, д. 25, кв. 12',
    avatar: 'АП',
    category: 'Электрика',
    experience: '8 лет',
  ...
  const [editForm, setEditForm] = useState<ExecutorProfile>(profile)
  ...
  const handleSave = () => {
    setProfile(editForm)
    localStorage.setItem('executorProfile', JSON.stringify(editForm))
    setIsEditing(false)
  }
  ...
  const handleInputChange = (field: keyof ExecutorProfile, value: string) => {
    setEditForm(prev => ({ ...prev, [field]: value }))
  }

  return (
    <div className="min-h-screen bg-gray-50">
      <Header userRole="executor" userName={`${profile.firstName} ${profile.lastName}`} notificationsCount={3} />
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Управляйте профессиональной информацией и настройками аккаунта
          </p>
        </div>
          ...
          <div className="lg:col-span-1">
            <div className="card">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-primary-600 font-medium">{profile.category}</p>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="text-sm text-gray-500 space-y-2">
                  ...
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <span>Ставка: {profile.hourlyRate}</span>
                  </div>
                </div>
              </div>
            </div>
