  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 to-secondary-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center">
          ...
          <div className="space-y-3">
            ...
            <button 
              ...
              className="ml-3 px-4 py-2 text-sm bg-red-100 text-red-700 rounded-md hover:bg-red-200 transition-colors"
            >
              🚪 Выйти из системы
            </button>
          </div>
        ...
        <div className="mt-16 p-6 bg-white rounded-lg border border-secondary-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-2">
                <Link href="/dashboard/client">
                  <button className="w-full px-4 py-2 text-sm bg-primary-100 text-primary-700 rounded-md hover:bg-primary-200 transition-colors">
                    Кабинет клиента
                  </button>
                </Link>
                <Link href="/dashboard/client/search">
                  <button className="w-full px-4 py-2 text-sm bg-secondary-200 text-gray-700 rounded-md hover:bg-secondary-300 transition-colors">
                    Поиск мастеров
                  </button>
                </Link>
                <Link href="/dashboard/client/orders">
                  <button className="w-full px-4 py-2 text-sm bg-primary-200 text-primary-800 rounded-md hover:bg-primary-300 transition-colors">
                    Мои заказы
                  </button>
                </Link>
                <Link href="/dashboard/client/booking">
                  <button className="w-full px-4 py-2 text-sm bg-secondary-300 text-gray-800 rounded-md hover:bg-secondary-400 transition-colors">
                    Бронирование услуги
                  </button>
                </Link>
              </div>
