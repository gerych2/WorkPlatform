...
async function createExecutor() {
  try {
    console.log('Создание исполнителя...')
    ...
    const workingHours = [
      { dayOfWeek: 1, startTime: '09:00', endTime: '18:00', isWorking: true }, // Понедельник
      { dayOfWeek: 2, startTime: '09:00', endTime: '18:00', isWorking: true }, // Вторник
      { dayOfWeek: 3, startTime: '09:00', endTime: '18:00', isWorking: true }, // Среда
      { dayOfWeek: 4, startTime: '09:00', endTime: '18:00', isWorking: true }, // Четверг
      { dayOfWeek: 5, startTime: '09:00', endTime: '18:00', isWorking: true }, // Пятница
      { dayOfWeek: 6, startTime: '10:00', endTime: '16:00', isWorking: true }, // Суббота
      { dayOfWeek: 0, startTime: '10:00', endTime: '16:00', isWorking: false } // Воскресенье
    ]
